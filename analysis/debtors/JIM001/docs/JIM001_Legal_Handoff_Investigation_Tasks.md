...
**Checked, differently, for 2024-09/10/11 — and this one is weaker than the 2025/2026 check, read the caveat:** unlike 2025/2026, there *is* unconsumed cash floating around 2024 (R24,068.27 across four payment docs, plus a fifth doc `35270` at R18,441.12 sitting on a badly mis-lagged assignment — see the old Priority 3 section, now revised, and Bridge review §5.3). A full cash-flow reconstruction was tested to see if that cash covers Sept/Oct/Nov: it mathematically can, but only by requiring collections lag to halve for exactly those three months against the account's own pattern, then recover immediately. That was the basis for rejecting it.

**Caveat added the same day, after further testing:** the payment-lag test used to make that call is now known to produce false positives — it flags doc 40746's July-2025 assignment as an outlier, and that assignment is *proven correct* by the raw ERP's own invoice tagging. The Sept/Oct/Nov rejection still rests on a stronger version of the argument (a sustained three-month regime dip, not a single-month flag), but it is **`ASSERTED`, not proven**. Treat Sept/Oct/Nov 2024 as unpaid for claim purposes on the balance of evidence — but flag it as such to legal, and do not present it as established the way the 2025/2026 months can be. A single ERP export covering 2024-07 → 2025-03 would settle it outright; that is the cheapest way to firm up R41,887.32 of claim.
