...
def run_jennings_reconciliation():
    ...
    print(f"Version 2: Identified and stripped {len(stripped_docs)} matching cylinder documents (8 pairs) from Part 1.")
    ...
    exec_summary = f"""# Statement of Account: Jennings Gas (JEN001) - Version 2 (Stripped Matched CYL)
...
"""
    ...
    with open('analysis/debtors/JEN001/reports/JEN001_Statement_Account_v2.md', 'w') as f:
        f.write(exec_summary)
        
    print("Successfully generated JEN001_Statement_Account_v2.md")
