# Statement of Account: Spoon Eatery (JEN001) - Version 3 (Zero Cylinder B/F)
...
| **End Jan** | **Closing Balance** | — | **0** | **0** | **0** | **0** | **0** |
...
| Date | Entry Type | Doc # | 14kg Qty | 19kg Qty | 9kg Qty | D.1 Qty | S.1 Qty |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: |
| **01 Feb** | **Opening Balance** | — | **0** | **0** | **0** | **0** | **0** |
...
| **End Feb** | **Closing Balance** | — | **0** | **0** | **0** | **0** | **0** |
...
| **End Mar** | **Closing Balance** | — | **0** | **0** | **1** | **0** | **0** |
...
| Date | Entry Type | Doc # | 14kg Qty | 19kg Qty | 9kg Qty | D.1 Qty | S.1 Qty |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: |
| **01 Apr** | **Opening Balance** | — | **0** | **0** | **1** | **0** | **0** |
...
| **End Apr** | **Closing Balance** | — | **0** | **0** | **4** | **0** | **0** |
...
| Date | Entry Type | Doc # | 14kg Qty | 19kg Qty | 9kg Qty | D.1 Qty | S.1 Qty |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: |
| **01 May** | **Opening Balance** | — | **0** | **0** | **4** | **0** | **0** |
...
| **End May** | **Closing Balance** | — | **0** | **2** | **4** | **0** | **0** |
...
### 📊 Component Breakdown
*   **CYL Deposit Debt (Standardized VAT-Inclusive Rates):** R3,450.00 Debit
*   **Pure LPG Gas Balance (Gas Portion Only):** R19,993.04 Debit
