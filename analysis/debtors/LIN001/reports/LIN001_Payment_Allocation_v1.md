...
**Events with a matched payment and a rate-corrected, remaining gap:**
...
**Two threads remain, both with an explained-but-unclosed residual:** DN-21627's R1,449.00 (owed by the customer — his own counting error, not an ERP correction) and DN#21237's R362.85 (payment target still only Probable, not remittance-confirmed). Neither needs further ERP-side reconciliation — DN-21627 needs a collections conversation with evidence in hand; DN#21237 needs the same rigor applied to its payment target. DN#21541's R349.02 residual is similarly explained (customer's own rate-mismatch) and not chased further.
