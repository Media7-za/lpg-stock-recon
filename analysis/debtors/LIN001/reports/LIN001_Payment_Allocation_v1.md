...
**44975 (→DN#22630) removed from this table 2026-09-06** — promoted to `Confirmed` via the customer's own proforma quote, exact-cent match; see §2.
...
Unlike DN-21627's residual (owed by the customer due to his own error) or DN#21541's (a rate mismatch in the customer's reconciliation), this residual is a straightforward unreturned-deposit charge — confirmed legitimate by the signed delivery note, not a dispute or a posting error. **Rolling/cumulative account balance is now this account's adopted doctrine** (2026-09-06, see `.agents/skills/SKILL_LIN001_Debtor_Reconciliation.md` §2 and `LIN001_balance_bridge_2026-06_2026-09.md`) — on that basis this residual is immaterial (R477.83 cumulative), not R28,750.00. That doctrine is verified for the Jun–Sep window; extending it back through this ledger's fuller Nov 2025–Sep 2026 scope is a follow-up (see §6).
...
Total allocated via Probable/proximity edges (9)     R332,844.40
Total allocated via Confirmed remittance edges (5)   R264,225.60  (44974+43246+43247+44482+44975)
...
**One thread remains genuinely open as a collections matter:** DN-21627's R1,449.00, owed by the customer (his own counting error, confirmed by the customer, not an ERP correction) — this stands regardless of doctrine, since it's an individually acknowledged liability, not a cumulative-balance question. DN#21541's R349.02 residual is similarly explained (customer's own rate-mismatch) and not chased further; its two credit-note postings (CN top-up, empties credit) are still pending in ERP. DN#24817's R28,750.00 isolated / R477.83 rolling is a legitimate unreturned-deposit charge — under the now-adopted rolling doctrine, R477.83 is the number that matters, and it's immaterial.

**Doctrine note (2026-09-06):** rolling/cumulative account balance is now LIN001's standard doctrine (see `.agents/skills/SKILL_LIN001_Debtor_Reconciliation.md` §2), verified for the Jun–Sep 2026 window (`LIN001_balance_bridge_2026-06_2026-09.md`). It has **not** yet been extended back through this ledger's fuller Nov 2025–Sep 2026 scope — the R608,631.45/R598,868.18 figures above remain on the isolated-event basis pending that follow-up work. It does not change any individually-evidenced conclusion above (DN-21627's owed amount, DN#21541's explained residual) — only the judgment of whether an unexplained-by-itself gap is a live concern.
