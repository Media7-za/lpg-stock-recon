...
```
PROJECT NAME: [e.g. LPG Delivery System]
PURPOSE: [One sentence — what does this app do?]
...
REPOSITORY:
- GitHub: github.com/[org]/[repo-name]
...
- Deploy hook URL: https://api.vercel.com/v1/integrations/deploy/[hook-url]
